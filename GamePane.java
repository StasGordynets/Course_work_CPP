...
public class GamePane extends StackPane {
  ...
  private HBox createToolBar() {
    ...
    // Button btItem2 = createButtonItem("mRestore", "Replay Session",
    // t->gameManager.doRestoreSession());
    // Button btItem2 = createButtonItem("mRestore", "Replay Session",
    // t->gameManager.ActevetedReplayGame());GameBot.AnimationTimer.start();
    Button btItem2 = createButtonItem("mRestore", "Replay Session", t -> gameManager.ReplayRun());
    ...
    toolbar.getChildren().setAll(btItem1, btItem2, btItem3, btItem4, btItem5, btItem6);
    Button btItem7 = createButtonItem("mQuit", "Quit the Game", t -> gameManager.quitGame());
    toolbar.getChildren().add(btItem7);
    return toolbar;
  }

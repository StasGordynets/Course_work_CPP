...
public class GamePane extends StackPane {
  ...
  private HBox createToolBar() {
    ...
    Button Item1 = createButtonItem("mSave", "Set path to file", t -> gameManager.SaveFile());
    Button Item2 = createButtonItem("mRestore", "Open Path file", t -> gameManager.OpenFile());
    Button Item3 = createButtonItem("mBot", "Actevated Bot", t -> gameManager.BotGame());
    Button Item4 = createButtonItem("mPause", "Pause Game", t -> gameManager.pauseGame());
    Button Item5 = createButtonItem("mReplay", "Try Again", t -> gameManager.tryAgain());
    Button Item6 = createButtonItem("mInfo", "About the Game", t -> gameManager.aboutGame());
    Button Item7 = createButtonItem("mSorting", "Sorting of the Game", t->QSort.StageSorting());
    toolbar.getChildren().setAll(Item1, Item2, Item3, Item4, Item5, Item6, Item7);
    Button Item8 = createButtonItem("mQuit", "Quit the Game", t->gameManager.quitGame());
    toolbar.getChildren().add(Item8);
    return toolbar;
  }

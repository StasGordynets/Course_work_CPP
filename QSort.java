...
public class QSort {
  ...
  public static void createSortingTable(String name, String[] ms) {
    ...
    for (int tempruaryFirst = 0; tempruaryFirst < Board.count; tempruaryFirst++)
      model.addRow(new Object[] {ms[tempruaryFirst]});
    dialog.pack();
